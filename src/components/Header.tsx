...
function Header() {
    ...
    const matches = {
        '/': useMatch('/'),
        '/now-playing': useMatch('/now-playing'),
        '/coming-soon': useMatch('/coming-soon'),
    };
